...
public class Dictionary {
    ...
    public void insert(String word, DictionaryData data) {
        ...
        // System.out.println("inserting " + word + " with frequency " + frequency + " into the dictionary");
    ...
    public static List<Map.Entry<String, DictionaryData>> sortByValue(Map<String, DictionaryData> dictionaryMap) {
        List<Map.Entry<String, DictionaryData>> entryList = new LinkedList<Map.Entry<String, DictionaryData>>(dictionaryMap.entrySet());
        Collections.sort(entryList, new Comparator<Map.Entry<String, DictionaryData>>() {
            ...
            public int compare(Map.Entry<String, DictionaryData> o1, Map.Entry<String, DictionaryData> o2) {
                ...
                try {
                    ...
                    // You can choose to handle it in a specific way or ignore it
                    // For example, you can assign a default value or skip the comparison
                }
    ...
    public List<DictionaryData> alphabeticalList() {
        List<Map.Entry<String, DictionaryData>> list = new LinkedList<Map.Entry<String, DictionaryData>>(dictionaryMap.entrySet());
    ...
    public List<DictionaryData> frequencyOrderedList() {
        // List<DictionaryData> maplist = new LinkedList<DictionaryData>(dictionaryMap.values());
